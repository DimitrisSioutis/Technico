...
namespace Technico.Controllers
{
    ...
    public class RepairController : ControllerBase
    {
        ...
        [HttpGet("daily")]
        public async Task<ActionResult<List<RepairDTO>>> GetDaily()
        {
            return await _repairService.GetDailyAsync();
        }

        [HttpGet("ongoing")]
        public async Task<ActionResult<List<RepairDTO>>> GetOngoing()
        {
            return await _repairService.GetOngoingAsync();
        }
    }
}
