...
public class RepairService : IRepairService
{
    ...
    public async Task<List<RepairDTO>> GetDailyAsync()
    {
        var repairs = await _repairRepository.GetDailyAsync();
        return repairs.Select(repair => new RepairDTO
        {
            Id = repair.Id,
            ScheduledDate = repair.ScheduledDate,
    ...
    public async Task<List<RepairDTO>> GetOngoingAsync()
    {
        var repairs = await _repairRepository.GetOngoingAsync();
        return repairs.Select(repair => new RepairDTO
        {
            Id = repair.Id,
            ScheduledDate = repair.ScheduledDate,
